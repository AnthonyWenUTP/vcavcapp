...
import org.clintonhealthaccess.vca.server.tasks.UploadVisitasTask;
...
public class UploadVisitasActivity extends Activity implements UploadListener{

	protected static final String TAG = UploadVisitasActivity.class.getSimpleName();

	private String username;
	private String password;
	private String url;
	private SharedPreferences settings;
	private UploadVisitasTask uploadAllTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		uploadAllTask = (UploadVisitasTask) getLastNonConfigurationInstance();
	...
	private void uploadAll() {
		uploadAllTask =  new UploadVisitasTask(this.getApplicationContext());
		uploadAllTask.setUploadListener(UploadVisitasActivity.this);
