...
import org.clintonhealthaccess.vca.server.tasks.UploadViviendasTask;
...
public class UploadViviendasActivity extends Activity implements UploadListener{

	protected static final String TAG = UploadViviendasActivity.class.getSimpleName();

	private String username;
	private String password;
	private String url;
	private SharedPreferences settings;
	private UploadViviendasTask uploadAllTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		uploadAllTask = (UploadViviendasTask) getLastNonConfigurationInstance();
	...
	private void uploadAll() {
		uploadAllTask =  new UploadViviendasTask(this.getApplicationContext());
		uploadAllTask.setUploadListener(UploadViviendasActivity.this);
