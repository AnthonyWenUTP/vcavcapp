	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (p != null) {
			...
			textView = (TextView) v.findViewById(R.id.infoc_text);
				...
				textView.setText(this.getContext().getString(R.string.sprRooms) + ": " +p.getHousehold().getSprRooms()+"\n Estado vivienda: "+
											p.getSprayStatus());
				if(p.getSprayStatus().equals("Asignada")) {
			...
			if (imageView != null) {
				if (p.getSprayStatus().equals("Nunca visitada")) {
					imageView.setImageResource(R.drawable.red);
				} else if (p.getSprayStatus().equals("Descartada")) {
					imageView.setImageResource(R.drawable.black);
				} else if (p.getSprayStatus().equals("Asignada")) {
					imageView.setImageResource(R.drawable.blue);
				} else if (p.getSprayStatus().equals("Cerrada")) {
					imageView.setImageResource(R.drawable.orange);
				}else if (p.getSprayStatus().equals("Renuente")) {
					imageView.setImageResource(R.drawable.purple);
				}else if (p.getSprayStatus().equals("Rociada parcial")) {
					imageView.setImageResource(R.drawable.yellow);
				}else if (p.getSprayStatus().equals("Rociada total")) {
