...
public class MenuCriaderoAdapter extends ArrayAdapter<String> {

	private final String[] values;
	
	
	public MenuCriaderoAdapter(Context context, int textViewResourceId,
			String[] values, Criadero criadero) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case 1: 
			...
			break;
		case 2: 
			img=getContext().getResources().getDrawable( R.drawable.ic_menu_clear_playlist);
			textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
			break;			
		case 3: 
