...
public class MenuPuntoDxAdapter extends ArrayAdapter<String> {

	private final String[] values;
	private final PuntoDiagnostico mPunto;
	
	
	public MenuPuntoDxAdapter(Context context, int textViewResourceId,
			String[] values, PuntoDiagnostico punto) {
