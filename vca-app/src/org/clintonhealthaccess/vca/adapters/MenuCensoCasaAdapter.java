...
public class MenuCensoCasaAdapter extends ArrayAdapter<String> {

	private final String[] values;
	private final Household mVivienda;
	
	public MenuCensoCasaAdapter(Context context, int textViewResourceId,
			String[] values, Household vivienda) {
		super(context, textViewResourceId, values);
		this.values = values;
		this.mVivienda=vivienda;
	}
    ...
    public boolean isEnabled(int position) {
		...
		case 4:
			...
			if(mVivienda.getEstado()==Constants.STATUS_NOT_FINALIZED){
				habilitado = true;
			}else {
				habilitado = false;
			}
