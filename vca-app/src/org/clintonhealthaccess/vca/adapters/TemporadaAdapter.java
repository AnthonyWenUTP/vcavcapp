...
public class TemporadaAdapter extends ArrayAdapter<IrsSeason> {
	
	public TemporadaAdapter(Context context, int textViewResourceId,
                          List<IrsSeason> items) {
