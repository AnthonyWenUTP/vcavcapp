...
public class MenuMapeoAdapter extends ArrayAdapter<String> {

	private final String[] values;
	
	public MenuMapeoAdapter(Context context, int textViewResourceId,
			String[] values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case 0: 
			...
			break;
		case 1: 
			img=getContext().getResources().getDrawable( R.drawable.ic_menu_view);
			textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
			break;
		case 2: 
			...
			break;
		case 3: 
			img=getContext().getResources().getDrawable( R.drawable.ic_menu_compass);
			textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
			break;
		case 4: 
