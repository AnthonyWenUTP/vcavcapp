...
public class MenuMuestraAdapter extends ArrayAdapter<String> {

	private final String[] values;
	private final Muestra mMuestra;
	
	
	public MenuMuestraAdapter(Context context, int textViewResourceId,
			String[] values, Muestra muestra) {
		super(context, textViewResourceId, values);
		this.values = values;
		this.mMuestra=muestra;
	}
