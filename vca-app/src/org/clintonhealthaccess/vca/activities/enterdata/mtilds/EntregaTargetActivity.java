...
import org.clintonhealthaccess.vca.activities.mtilds.MenuMosquiterosCasaActivity;
import org.clintonhealthaccess.vca.database.VcaAdapter;
import org.clintonhealthaccess.vca.domain.mtilds.EntregaTarget;
import org.clintonhealthaccess.vca.forms.mtilds.EntregaTargetForm;
...
public class EntregaTargetActivity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mWizardModel = new EntregaTargetForm(this,mPass,meta.getIdent());
        ...
        try {
        	...
        	if (meta != null) {
        		...
        		if(meta.getHabitantes()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de habitantes");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getHabitantes()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }

        		if(meta.getSitiosDormirCama()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de sitios para dormir tipo cama");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getSitiosDormirCama()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
        		
        		if(meta.getSitiosDormirHamaca()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de sitios para dormir tipo hamaca");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getSitiosDormirHamaca()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
        		
        		if(meta.getSitiosDormirSuelo()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de sitios para dormir tipo suelo");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getSitiosDormirSuelo()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
        		
        		if(meta.getSitiosDormirOtro()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de sitios para dormir de otro tipo");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getSitiosDormirOtro()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
        		
        		if(meta.getMtildExistentes()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Número de MTILDs existentes");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getMtildExistentes()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
        		
        		if(meta.getMosqSinInsecticida()!=null){
    	        	modifPage = (NumberPage) mWizardModel.findByKey("Mosquiteros sin insecticida");
    	            dato = new Bundle();
    	            dato.putString(SIMPLE_DATA_KEY, String.valueOf(meta.getMosqSinInsecticida()));
    	            modifPage.resetData(dato);
    	            modifPage.setmVisible(true);
    	        }
            ...
            case EXIT:
                ...
                builder.setPositiveButton(this.getString(R.string.yes), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                    	...
                    	if (meta!=null) arguments.putSerializable(Constants.LOCALIDAD , meta.getHousehold().getLocal());
