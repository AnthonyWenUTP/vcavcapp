...
import org.clintonhealthaccess.vca.adapters.MenuMosquiterosAdapter;
...
public class MenuMosquiterosActivity extends AbstractAsyncActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("Ciclo de entrega: "+mTemporada.getName()+"\n"+
							getString(R.string.localidad)+": "+mLocalidad.getName());
		
		
		menuMosquiteros = getResources().getStringArray(R.array.menu_mosquiteros);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				case 1:
					createDialog(UPLOAD);	
				case 2: // REGRESAR MENU PRINCIPAL
					i = new Intent(getApplicationContext(),
							MainActivity.class);
					i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(i);
		...
		gridView.setAdapter(new MenuMosquiterosAdapter(getApplicationContext(), R.layout.menu_item_2, menuMosquiteros));
	}
