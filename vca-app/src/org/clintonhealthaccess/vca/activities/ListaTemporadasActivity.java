...
public class ListaTemporadasActivity extends AbstractAsyncListActivity {
	...
	protected void onListItemClick(ListView listView, View view, int position,
		...
		String nombreTemporada = temporada.getName();
		String codTemporada = temporada.getIdent();
		
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        Editor editor = sharedPreferences.edit();
        editor.putString(PreferencesActivity.KEY_TEMPORADA, nombreTemporada);
        editor.commit();
        editor.putString(PreferencesActivity.KEY_CODE_TEMPORADA, codTemporada);
        editor.commit();
        Toast.makeText(getApplicationContext(), this.getString(R.string.choose_temporada) + ">>>> " + temporada.getName(), Toast.LENGTH_LONG).show();
        finish();
