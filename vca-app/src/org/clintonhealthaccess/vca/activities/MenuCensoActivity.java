...
import org.clintonhealthaccess.vca.server.UploadViviendasActivity;
import org.clintonhealthaccess.vca.utils.Constants;
import org.clintonhealthaccess.vca.adapters.MenuCensoAdapter;
...
public class MenuCensoActivity extends AbstractAsyncActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		textView.setText(getString(R.string.localidad)+":"+mLocalidad.getName()+"\n"+
							getString(R.string.distrito)+":"+mLocalidad.getDistrict().getName()+"\n"+
								getString(R.string.area)+":"+mLocalidad.getDistrict().getArea().getName());
		
		
		menuCensus = getResources().getStringArray(R.array.menu_census);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				switch(position){ 
				case 0: // INGRESAR BUSCAR VIVIENDA
				...
				case 2:
					...
					startActivity(i);
					break;		
				case 3: // REGRESAR MENU PRINCIPAL
					i = new Intent(getApplicationContext(),
							MainActivity.class);
					i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(i);
		...
		gridView.setAdapter(new MenuCensoAdapter(getApplicationContext(), R.layout.menu_item_2, menuCensus));
	}
		...
		case UPLOAD:
			...
			builder.setPositiveButton(this.getString(R.string.yes), new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					dialog.dismiss();
					Intent ie = new Intent(getApplicationContext(), UploadViviendasActivity.class);
