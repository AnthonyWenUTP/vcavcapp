...
public class UbicacionInfeccionCasoActivity extends AbstractAsyncActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		infoMovil = new DeviceInfo(UbicacionInfeccionCasoActivity.this);
		...
		textViewHeader.setText("Ubicación lugar de infección del caso");
		...
		textViewCaso.setText(getString(R.string.codeCase)+":"+mCaso.getCodigo()+"\n"+
				getString(R.string.localidad)+":"+mCaso.getLocal().getName()
					+"\n\n"+
				" Datos actuales:\n");
		if(mCaso.getLatitudeOrigin()==null||mCaso.getLatitudeOrigin()==0) {
			textViewLatitud.setText("Latitud no establecida");
		}else{
			textViewLatitud.setText("Latitud: " + mCaso.getLatitudeOrigin().toString());
		}
		
		if(mCaso.getLongitudeOrigin()==null||mCaso.getLongitudeOrigin()==0) {
			textViewLongitud.setText("Longitud no establecida");
		}else{
			textViewLongitud.setText("Longitud: "+mCaso.getLongitudeOrigin().toString());
		}
	 	...
	 	private class SaveDataTask extends AsyncTask<String, Void, String> {
	 		...
	 		protected String doInBackground(String... values) {
	 			...
	 			try {
	 				...
	 				mCaso.setLatitudeOrigin(latitud);
	 				mCaso.setLongitudeOrigin(longitud);
