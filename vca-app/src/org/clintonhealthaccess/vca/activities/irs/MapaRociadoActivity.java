...
public class MapaRociadoActivity extends AbstractAsyncActivity {
    MapView map = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchHouseholdsLocalidadTask().execute(mLocalidad.getIdent(),mTemporada.getIdent(),String.valueOf(opcionSeleccionada));
	...
	public void onBackPressed (){
		finish();
		Bundle arguments = new Bundle();
		Intent i = new Intent(getApplicationContext(), RociadoActivity.class);
		if (mLocalidad != null) arguments.putSerializable(Constants.LOCALIDAD, mLocalidad);
		if (mTemporada != null) arguments.putSerializable(Constants.TEMPORADA, mTemporada);
		arguments.putString(Constants.ROLES, roles);
		i.putExtras(arguments);
		...
		private class FetchHouseholdsLocalidadTask extends AsyncTask<String, Void, String> {
			...
			protected String doInBackground(String... values) {
				...
				String opcion = values[2];
				try {
					vcaAdapter.open();
					if(opcion.equals("0")) {
						mTargets = vcaAdapter.getTargets2(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("1")) {
						mTargets = vcaAdapter.getNovisitadas(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("2")) {
						mTargets = vcaAdapter.getAsignadas(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("3")) {
						mTargets = vcaAdapter.getCerradas(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("4")) {
						mTargets = vcaAdapter.getRenuentes(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("5")) {
						mTargets = vcaAdapter.getDestruidas(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("6")) {
						mTargets = vcaAdapter.getRociadas(strTemporada,strLocalidad,"");
					}
					else if(opcion.equals("7")) {
						mTargets = vcaAdapter.getParciales(strTemporada,strLocalidad,"");
					}
					vcaAdapter.close();
				} catch (Exception e) {
