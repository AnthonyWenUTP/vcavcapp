...
public class MapaPreAvisoActivity extends AbstractAsyncActivity {
    MapView map = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchHouseholdsLocalidadTask().execute(mLocalidad.getIdent(),mTemporada.getIdent(),"");
	...
	public void onBackPressed (){
		finish();
		Bundle arguments = new Bundle();
		Intent i = new Intent(getApplicationContext(), RociadoPreAvisoActivity.class);
		if (mLocalidad != null) arguments.putSerializable(Constants.LOCALIDAD, mLocalidad);
		if (mTemporada != null) arguments.putSerializable(Constants.TEMPORADA, mTemporada);
		arguments.putString(Constants.ROLES, roles);
		i.putExtras(arguments);
		...
		private class FetchHouseholdsLocalidadTask extends AsyncTask<String, Void, String> {
			...
			protected String doInBackground(String... values) {
				...
				try {
					vcaAdapter.open();
					mTargets = vcaAdapter.getTargetsPreaviso(strTemporada,strLocalidad,filtro);
					vcaAdapter.close();
				} catch (Exception e) {
